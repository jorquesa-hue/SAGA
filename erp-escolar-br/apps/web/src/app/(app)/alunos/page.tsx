...
import { AlunosTab } from "@/features/cadastros";
...
export default function BuscarAlunosPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="h-page">Alunos</h1>
        <p className="subtle mt-1">
          Busque pelo nome ou código de matrícula para ver a situação financeira, ou
          cadastre um novo aluno abaixo.
        </p>
      </div>
      ...
      <section className="border-t border-ink-200 pt-6">
        <h2 className="h-section mb-1">Cadastrar aluno</h2>
        <p className="subtle mb-4">
          O aluno passa a existir aqui; a turma e o contrato vêm depois, em Matrículas.
        </p>
        <AlunosTab />
      </section>
    </div>
