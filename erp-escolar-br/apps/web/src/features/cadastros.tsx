// The student-life-cycle routes (/alunos, /matriculas, /escola, /equipe) each
// render one or more of these panels. They used to be tabs inside a single
// "Cadastros" page; the page was split so each stage of a student's life has
// its own address, but the panels themselves are unchanged.
